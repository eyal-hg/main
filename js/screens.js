/* HK Dashboard — scope routing, chat drawer, toast, tabs, metrics+alert rules editor, AI chat, reports */
  function setScope(s){
    ...
    if(s==='portfolio'){
      ...
      /* בעל העסק לא רואה שורת "מלווה על ידי" — המותג של המשרד יושב בלוגו
         שבפס העליון (הכרעת אייל 04.09, וכך גם במוצר). */
      sub.textContent=(ROLE==='client1'||ROLE==='clientN')
        ? 'עודכן 2.7.2026 10:54'
