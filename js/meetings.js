/* HK Dashboard — meetings list + summary modal */
  ...
  const MEETINGS=[
    ...
    {name:'פגישה חודשית — יולי', client:'משה עובד', who:'משה עובד', date:'02.07.2026', time:'16:00-17:00', adv:'אילון שחר', status:'upcoming', link:'zoom'},
    ...
    {name:'פגישה חודשית — יולי', client:'מטעי גבעון', who:'יעל גבעון', date:'15.07.2026', time:'10:00-11:00', adv:'אילון שחר', status:'upcoming'},
