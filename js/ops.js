/* HK Dashboard — operations mode: timer, role, enter/exit, finish flow (Bizibox checks), task handling */
  ...
  function setRole(r){
    ...
    /* במוצר בורר התצוגה קיים רק בממשק מנהל התזרים (docs/ROLES.md). במוקאפ הוא גלוי בכל
       תצוגה — אייל צריך אותו כדי לעבור מאחת לאחרת. */
    if(OPSMODE) exitOps();
  ...
  function finAllDone(){
    ...
    /* אין עוד אזור עליון נפרד: הסיכום, התיעוד והחריגות חיים באותו
       מבנה של שתי עמודות, כל אחד מיושר לעמודה שלו. */
    document.getElementById('finFindings').innerHTML='';
  ...
  function finRecapHtml(){
    ...
    /* שתי הטבלאות בקופסה אחת, בעמודת השליחה — מה שנעשה ומה שנבדק,
       בדיוק מעל הכפתור ששולח את התוצאה. */
    return `<div class="frec-box"><div class="frec-wrap">
  ...
  function renderFinFoot(){
    ...
    foot.innerHTML=`<div class="fin-2col"><div class="fin-c-exc">`+finCallHtml()+excHtml+`</div><div class="fin-c-send">`+
      finRecapHtml()+`
...
const MSGS_THREADS={
  group:{name:'תפעול · אנרגי אינטרנשיונל', ppl:[
      ...
      {n:'054-000-0000',r:'unk',unk:1},{n:'העוזר',j:'אוטומטי',r:'bot'}], unread:2, msgs:[
    ...
    {who:'054-000-0000', role:'unk', unk:1, t:'שלום, מצרף את הצעת המחיר לליסינג החדש [PDF]', time:'12:58'},
    {who:'העוזר', job:'אוטומטי', role:'bot', t:'📋 סיכום פגישת 09:00 נשלח · נפתחו 3 משימות', time:'13:05'},
    {sum:{ran:'02:10', n:15, unk:'054-000-0000', lines:[
    ...
    {who:'054-000-0000', role:'unk', unk:1, t:'מתי נוח לכם לדבר על ההצעה?', time:'13:15'},
    {sum:{pending:4}},
  ]},
