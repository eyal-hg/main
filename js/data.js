/* HK Dashboard — seed data: CLIENTS (בפרודקשן: שכבת API) */
  const CLIENTS = [
    ...
    { name:'משה עובד', hp:'039112774', mgr:'לירון בן כליפא', status:'active', unread:0, sync:'01.07 10:26', opsPending:0 },
    { name:'רימון יצחק', hp:'025664109', mgr:'לירון בן כליפא', status:'active', unread:0, sync:'01.07 10:26', opsPending:1 },
  ];
